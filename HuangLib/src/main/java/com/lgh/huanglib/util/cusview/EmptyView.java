...
public class EmptyView extends FrameLayout {
    ...
    private void init() {
        ...
        mDetailImageView = (ImageView) findViewById(R.id.empty_view_image);
    }
    ...
    public void show(int res, String detailText) {
        setLoadingShowing(false);
        setTitleText(null);
        setDetailText(detailText);
        setButton(null, null);
        setDetailImageView(res);
        show();
    }
    ...
    public void setDetailImageView(int res) {
        if (res != -1){

            mDetailImageView.setImageResource(res);
        }
        mDetailImageView.setVisibility(res != -1 ? VISIBLE : GONE);
    }
