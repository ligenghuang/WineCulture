package com.lgh.huanglib.util.cusview.magicIndicator.buildins.commonnavigator;
...
import com.lgh.huanglib.util.cusview.magicIndicator.NavigatorHelper;
import com.lgh.huanglib.util.cusview.magicIndicator.ScrollState;
import com.lgh.huanglib.util.cusview.magicIndicator.abs.IPagerNavigator;
import com.lgh.huanglib.util.cusview.magicIndicator.buildins.commonnavigator.abs.CommonNavigatorAdapter;
import com.lgh.huanglib.util.cusview.magicIndicator.buildins.commonnavigator.abs.IMeasurablePagerTitleView;
import com.lgh.huanglib.util.cusview.magicIndicator.buildins.commonnavigator.abs.IPagerIndicator;
import com.lgh.huanglib.util.cusview.magicIndicator.buildins.commonnavigator.abs.IPagerTitleView;
import com.lgh.huanglib.util.cusview.magicIndicator.buildins.commonnavigator.model.PositionData;
