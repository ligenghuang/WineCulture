...
public class SharedPreferencesUtils {
    ...
    protected SharedPreferencesUtils() {
        mSharedPreferences = MyApplication.getInstance().getSharedPreferences(SharedFILE_NAME, Context.MODE_PRIVATE);
    ...
    public static void setParam(String key, Object value) {
        SharedPreferences sharedPreferences = MyApplication.getInstance().getSharedPreferences(SharedFILE_NAME, Context.MODE_PRIVATE);
