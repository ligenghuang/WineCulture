 ...
 * @Description:
 * @Author: lgh
 * @CreateDate: 2019/9/20 11:46
 * @Version: 1.0
 */

public class BuyPwdDialog extends Dialog implements DialogInterface.OnDismissListener {
    ...
    public BuyPwdDialog(@NonNull Context context, int themeResId, double money, String payTypeName) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_buy_pwd);
