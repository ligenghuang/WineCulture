...
/**
  ...
  * @Description:    
  * @Author:         lgh
  * @CreateDate:     2019/10/11 11:26
  * @Version:        1.0
 */

public class LikeGoodsAdapter extends BaseRecyclerAdapter<HomeDto.DataBean.LikeBean> {
    Context context;
    ...
    @Override
    protected void onBindViewHolder(SmartViewHolder holder, HomeDto.DataBean.LikeBean model, int position) {
